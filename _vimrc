...
" Last Edit: 15/Jun/2012 12:07 PM
" vim:fdm=marker
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
" Map F1 to ESC for Autodesk Laptop
map <F1> <ESC>
imap <F1> <ESC>
...
nmap <leader>9 :e $HOME\vimfiles\plugin\default_snippets.template<cr>
nmap <leader>( :tabnew $HOME\vimfiles\plugin\default_snippets.template<cr>
" }}}
...
nnoremap ;l :call g:ToggleNuMode()<cr>
